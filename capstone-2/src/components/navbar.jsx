  ...
  return (
    <div>
      <nav className="w-full h-[5rem] bg-[#967259] flex items-center justify-between px-10">
        ...
        <NavLink to='/'>
          <h1 className="logo-heading text-4xl cursor-pointer" style={{ fontFamily: 'Orbitron, sans-serif' }}>
            FocusLab
          </h1>
        </NavLink>

        <ul className="flex gap-8 text-[#FBF0E3] text-lg h-full" style={{ fontFamily: 'Orbitron, sans-serif' }}>
          <NavLink
            className={({ isActive }) =>
              isActive
