  ...
  if (!userGroup) {
    return (
      <>
        <div className="bg-[#E9CA9F] min-h-screen">
          ...
          <div className="flex justify-center items-center min-h-[80vh]">
            <div className="bg-white rounded-lg p-8 shadow-2xl shadow-amber-900/50 transform hover:scale-105 transition-all duration-300 max-w-md w-full mx-4 border border-gray-100">
              <h2 className="text-2xl font-bold text-[#B6825E] mb-6 text-center">
                Study Groups
              </h2>
        ...
        {/* Create Group Modal */}
        {showCreateGroup && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 transition-none">
            <div className="bg-white px-8 py-10 rounded-lg max-w-md w-full mx-4">
              <h3 className="text-2xl font-bold mb-6 text-center">Create Group</h3>
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  createGroup();
        ...
        {showJoinGroup && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 transition-none">
            <div className="bg-white p-8 rounded-lg max-w-md w-full mx-4">
              <h3 className="text-2xl font-bold mb-6 text-center">Join Group</h3>
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  joinGroup();
